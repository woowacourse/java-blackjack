...
- [x] 배팅 결과를 계산한다.
    - [x] 처음 두 장의 카드 합이 21일 경우 플레이어는 배팅 금액의 1.5배를 돌려받는다.
    - [x] 플레이어와 딜러가 동시에 두 장의 카드 합이 21일 경우 플레이어는 배팅한 금액을 돌려받는다.
    - [x] 딜러가 21을 초과하는 경우 모든 플레이어는 배팅한 금액을 돌려받는다.
    - [x] 플레이어가 21을 초과하는 경우 배팅 금액을 모두 잃는다.
