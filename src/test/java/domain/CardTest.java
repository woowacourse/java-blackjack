...
public class CardTest {
    ...
    void createCard() {
        Assertions.assertThatThrownBy(() -> Card.getCard(null, null))
    ...
    void getCardType() {
        Assertions.assertThat(Card.getCard(CardType.SPADE, CardNumber.TWO).getCardType())
    ...
    void getCardNumber() {
        Assertions.assertThat(Card.getCard(CardType.SPADE, CardNumber.TWO).getCardNumber())
