...
### 2단계 구현
- [ ] 배팅
  - [ ] 플레이어가 버스트일 경우 배팅 금액을 모두 잃게 된다.
  - [ ] 2장의 카드로만 21점이 될 경우 블랙잭이다.
  - [ ] 블랙잭일 경우 배팅 금액의 1.5배를 딜러에게 받는다.
  - [ ] 딜러와 플레이어가 모두 블랙잭일 경우 플레이어는 배팅한 금액을 돌려받는다.
  - [ ] 딜러가 버스트일 경우  

### 2단계 리팩토링
- [ ] CardsGenerator가 52개의 카드를 생성해준다는 사실을 알 수 있도록 메서드명 변경
- [ ] 게임의 결과를 Game 클래스가 꼭 들고 있어야 될까?
