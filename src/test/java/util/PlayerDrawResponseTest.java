...
class PlayerDrawResponseTest {
	...
	void validateRightResponseTest(String value) {
		assertThatThrownBy(() -> PlayerDrawResponse.isYes(value)).isInstanceOf(IllegalArgumentException.class);
	}
	...
	void isMoreDrawTest(String value, boolean expected) {
		assertThat(PlayerDrawResponse.isYes(value)).isEqualTo(expected);
	}
}