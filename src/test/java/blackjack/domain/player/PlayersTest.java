...
public class PlayersTest {
    ...
    void create_players() {
        ...
        Player aki = new Participant(new Name("aki"), deck);
        Player alien = new Participant(new Name("alien"), deck);
    ...
    void duplicate_name_error() {
        Deck deck = new RandomDeck();
        Player aki1 = new Participant(new Name("aki"), deck);
        Player aki2 = new Participant(new Name("aki"), deck);
    ...
    void same_dealer_name_error() {
        Deck deck = new RandomDeck();
        Player player = new Participant(new Name("딜러"), deck);
