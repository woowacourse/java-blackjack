...
class DeckTest {
    ...
    public void checkAddCard() {
        deck.addCard(new Card(Suit.SPADE, Symbol.EIGHT));
        Deck comparedDeck = new Deck();
        comparedDeck.addCard(new Card(Suit.SPADE, Symbol.EIGHT));
    ...
    public void checkSumDeckCardsPoint() {
        deck.addCard(new Card(Suit.SPADE, Symbol.EIGHT));
        deck.addCard(new Card(Suit.SPADE, Symbol.TWO));
    ...
    public void checkSumDeckThreeCardsPoint() {
        deck.addCard(new Card(Suit.SPADE, Symbol.EIGHT));
        deck.addCard(new Card(Suit.SPADE, Symbol.TWO));
        deck.addCard(new Card(Suit.SPADE, Symbol.JACK));
        int sumPoint = deck.sumPoints();
    ...
    public void checkPointsForFourAces() {
        deck.addCard(new Card(Suit.SPADE, Symbol.ACE));
        deck.addCard(new Card(Suit.CLUB, Symbol.ACE));
        deck.addCard(new Card(Suit.DIAMOND, Symbol.ACE));
        deck.addCard(new Card(Suit.HEART, Symbol.ACE));
        int sumPoint = deck.sumPoints();
    ...
    public void checkPointsForThreeAces() {
        ...
        deck.addCard(new Card(Suit.CLUB, Symbol.ACE));
        deck.addCard(new Card(Suit.DIAMOND, Symbol.ACE));
        deck.addCard(new Card(Suit.DIAMOND, Symbol.TWO));
        int sumPoint = deck.sumPoints();
    ...
    public void checkPointsForTwoAces() {
        deck.addCard(new Card(Suit.SPADE, Symbol.ACE));
        deck.addCard(new Card(Suit.CLUB, Symbol.ACE));
        deck.addCard(new Card(Suit.DIAMOND, Symbol.NINE));
        int sumPoint = deck.sumPoints();
    ...
    public void checkPointsForTwoAcesOverLimit() {
        deck.addCard(new Card(Suit.SPADE, Symbol.ACE));
        deck.addCard(new Card(Suit.CLUB, Symbol.ACE));
        deck.addCard(new Card(Suit.DIAMOND, Symbol.JACK));
        int sumPoint = deck.sumPoints();
