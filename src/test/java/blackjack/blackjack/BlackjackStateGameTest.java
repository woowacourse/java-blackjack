...
class BlackjackStateGameTest {
    ...
    void 플레이어가_존재하면_true를_반환한다() {
        ...
        BlackjackGame blackjackGame = new BlackjackGame(
                new Participants(dealer, new Players(
    ...
    void 플레이어가_존재하지_않으면_false를_반환한다() {
        // Given
        BlackjackGame blackjackGame = new BlackjackGame(new Participants(dealer, new Players(
                List.of(new Player(provide16Cards(), "밍트", BigDecimal.valueOf(3000))))));
    ...
    void 현재_턴의_플레이어를_반환한다() {
        ...
        BlackjackGame blackjackGame = new BlackjackGame(new Participants(dealer, new Players(List.of(mint))));
