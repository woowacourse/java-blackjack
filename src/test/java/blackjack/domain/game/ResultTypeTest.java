...
public class ResultTypeTest {
    ...
    class GetProfitOfTest {
        ...
        void getProfitOf_blackjackWin() {
            int actual = ResultType.BLACKJACK_WIN.getProfitOf(DEFAULT_BETTING_AMOUNT);
        ...
        void getProfitOf_blackjackWinIgnoreDecimals() {
            int actual = ResultType.BLACKJACK_WIN.getProfitOf(3);
            int expected = 4; // 4.5
        ...
        void getProfitOf_win() {
            int actual = ResultType.WIN.getProfitOf(DEFAULT_BETTING_AMOUNT);
        ...
        void getProfitOf_lose() {
            int actual = ResultType.LOSE.getProfitOf(DEFAULT_BETTING_AMOUNT);
        ...
        void getProfitOf_draw() {
            int actual = ResultType.DRAW.getProfitOf(DEFAULT_BETTING_AMOUNT);
            int expected = 0;
