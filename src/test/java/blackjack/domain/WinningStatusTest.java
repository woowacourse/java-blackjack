...
class WinningStatusTest {
    ...
    void 손패_두_개가_주어졌을_때_두_손패_모두_버스트가_아니라면_21에_근접한_손패가_이긴다() {
        final PlayerBlackjackCardHand winner = new PlayerBlackjackCardHand(DEFAULT_PLAYER, new CardHandInitializerDummy());
        winner.addCard(HEART_10);
        winner.addCard(HEART_1);
        
        final PlayerBlackjackCardHand looser = new PlayerBlackjackCardHand(DEFAULT_PLAYER, new CardHandInitializerDummy());
