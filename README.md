...
- [ ]  딜러와 각 참가자들에 대한 승패를 판정한다.
    - [ ]  딜러와 참가자의 카드 합이 모두 21을 넘으면 딜러의 승리이다.
    - [ ]  딜러와 참가자 중 21을 넘지 않고 21에 더 가까운 사람이 승리한다.
    - [ ] 딜러의 카드 합이 21을 넘고 참가자의 카드합이 21을 넘지 않으면 참가자가 승리한다.
    - [ ] 딜러의 카드합이 21을 넘지않고 참가자의 카드합이 21을 넘으면 딜러가 승리한다.
    - [ ]  딜러가 Blackjack이고 참가자가 Blackjack이 아니면 딜러가 승리한다.
    - [ ] 딜러가 Blackjack이고 참가자도 Blackjack이면 무승부 이다.
    - [ ]  딜러와 참가자의 점수가 21을 넘지 않고 동점일 경우 무승부로 한다.
    - [ ] 딜러가 Blackjack이 아니고 참가자가 Blackjack이면 참가자가 승리한다.
