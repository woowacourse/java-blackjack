...
class BlackjackTest {
    ...
    void profit() {
        double profit = playerStatus.calculateProfit(true, new Score(30), new BettingMoney("3000"));
    ...
    void profit2() {
        double profit = playerStatus.calculateProfit(false, new Score(30), new BettingMoney("3000"));
