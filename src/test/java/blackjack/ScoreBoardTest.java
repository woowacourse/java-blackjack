...
public class ScoreBoardTest {
    ...
    void calculateResult() {
        ...
        Map<Player, Integer> results = ScoreBoard.calculateResult(blackjack.getDealer(), blackjack.getPlayers());

        assertThat(results.get(blackjack.getPlayers().get(0))).isEqualTo(-1);
    }
}
