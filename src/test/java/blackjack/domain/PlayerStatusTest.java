...
public class PlayerStatusTest {
    ...
    void calculateBettingMoneyWhenBlackjackWin() {
        ...
        playerStatus.calculateBettingMoney(Outcome.BLACKJACK_WIN.getBenefit());
    ...
    void calculateBettingMoneyWhenWin() {
        ...
        playerStatus.calculateBettingMoney(Outcome.WIN.getBenefit());
    ...
    void calculateBettingMoneyWhenTie() {
        ...
        playerStatus.calculateBettingMoney(Outcome.TIE.getBenefit());
    ...
    void calculateBettingMoneyWhenLose() {
        ...
        playerStatus.calculateBettingMoney(Outcome.LOSE.getBenefit());
