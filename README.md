...
- [x]  `ACE` 는 1 또는 11 로 계산할 수 있다.
- [x]  `JACK` `QUEEN` `KING` 은 10 으로 계산한다.
...
- [ ]  베팅한 금액만큼의 수익을 얻는다.
- [ ]  블랙잭으로 승리 시 베팅한 금액의 1.5 배의 수익을 얻는다.
...
- 플레이어가 블랙잭으로 이겼을 경우 베팅 금액의 1.5 배의 수익을 반환한다.
- 플레이어가 이겼을 경우 베팅 금액만큼의 수익을 반환한다.
