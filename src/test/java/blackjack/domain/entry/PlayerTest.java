...
public class PlayerTest {
    ...
    void getTwoCards() {
        Player player = new Player("jason", HoldCards.init(List.of(Card.valueOf(Suit.SPADE, Number.KING), Card.valueOf(Suit.SPADE, Number.ACE))));
    ...
    void putCard() {
        Player player = new Player("jason", HoldCards.init(List.of(Card.valueOf(Suit.SPADE, Number.NINE), Card.valueOf(Suit.SPADE, Number.ACE))));
    ...
    void playerIsLoseByOver21() {
        Player player = new Player("jason", HoldCards.init(List.of(Card.valueOf(Suit.SPADE, Number.KING), Card.valueOf(Suit.SPADE, Number.ACE))));
        Dealer dealer = new Dealer(HoldCards.init(List.of(Card.valueOf(Suit.SPADE, Number.KING), Card.valueOf(Suit.SPADE, Number.JACK))));
    ...
    void playerIsWinByDealerOver21() {
        Player player = new Player("jason", HoldCards.init(List.of(Card.valueOf(Suit.SPADE, Number.NINE), Card.valueOf(Suit.SPADE, Number.ACE))));
        Dealer dealer = new Dealer(HoldCards.init(List.of(Card.valueOf(Suit.SPADE, Number.KING), Card.valueOf(Suit.SPADE, Number.ACE))));
