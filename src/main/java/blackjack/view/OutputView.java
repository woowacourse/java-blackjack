...
public class OutputView {
    ...
    private static final String CARDS_GUIDE_MESSAGE = "카드: ";
    ...
    public static void printShowUsersCardMessage(List<Player> players) {
        ...
        System.out.printf(FIRST_CARD_DRAW_MESSAGE, String.join(DELIMITER, playerNames));
    }

    public static void showCards(Dealer dealer, List<Player> players) {
        System.out.println(dealer.getName() + CARDS_GUIDE_MESSAGE + dealer.getFirstCard());
        players
            .forEach(player -> System.out.println(printUserCards(player)));
    }

    public static String printUserCards(User user) {
        return user.getName() + CARDS_GUIDE_MESSAGE + user.getCards();
    }
    ...
    public static void printCardsAndScore(Dealer dealer, List<Player> players) {
        System.out
            .println(printUserCards(dealer) + printScore(dealer));
        players.forEach(
            player -> System.out.println(printUserCards(player) + printScore(player)));
    }
