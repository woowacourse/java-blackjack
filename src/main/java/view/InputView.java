...
public class InputView {
    ...
    private static final String BETTING_COST = "%s의 배팅 금액은?";
    ...
    public String readBettingCost(String name) {
        return printAndGet(BETTING_COST.formatted(name));
    }

    private String printAndGet(String instruction) {
