...
public class ResultGeneratorTest {
    ...
    void create() {
        ...
        User playerB = new User("유저B");
        Dealer dealer = new Dealer();
        CardDeck cardDeck = new CardDeck(CardFactory.create());
        cardDeck.shuffle();
        CardDistributor.giveOneCard(cardDeck, userA);
        CardDistributor.giveOneCard(cardDeck, userA);
        CardDistributor.giveOneCard(cardDeck, playerB);
        CardDistributor.giveOneCard(cardDeck, playerB);
        dealer.addCard(cardDeck.drawOne());
        dealer.addCard(cardDeck.drawOne());

        assertThat(ResultGenerator.create(dealer, new Users(Arrays.asList(userA, playerB)))).isInstanceOf(Results.class);
    }
}
