...
class BlackJackTest {
    ...
    void validateDealerIsNotNull() {
        ...
        Assertions.assertThatThrownBy(() -> new BlackJack(new Participants(
                List.of(new Participant("배키", participantCards, new BettingMoney(100)),
                        new Participant("켬미", participantCards, new BettingMoney(200)))),
                                null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    @Test
    void findLoseOutcomeParticipantOverThreshold() { //todo 이름 클래스
        Participant participant1 = createBustParticipant("배키", new BettingMoney(100));
        Participant participant2 = createBustParticipant("켬미", new BettingMoney(200));
    ...
    void participantWinWhenDealerBust() {
        Participant bustParticipant = createBustParticipant("배키", new BettingMoney(100));
        Participant notBustParticipant = createNotBustParticipant("켬미", new BettingMoney(200));
    ...
    void findDrawOutcome() {
        Participant notBustParticipant1 = createNotBustParticipant("켬미", new BettingMoney(100));
        Participant notBustParticipant2 = createNotBustParticipant("배키", new BettingMoney(200));
        Dealer notBustDealer = createNotBustDealer();
    ...
    public Participant createBustParticipant(String name, BettingMoney bettingMoney) {
    ...
    public Participant createNotBustParticipant(String name, BettingMoney bettingMoney) {
