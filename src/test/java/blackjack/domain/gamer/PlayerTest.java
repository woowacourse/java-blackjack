...
class PlayerTest {
    ...
    class PlayerLoseTest {
        ...
        void playerBustTest() {
            ...
            Dealer dealer = new Dealer(bustHand);

            GameResult gameResult = player.compete(dealer);
        ...
        void playerHandValueLowerThanDealer() {
            ...
            Dealer dealer = new Dealer(score21Hand);

            assertThat(player.compete(dealer)).isEqualTo(GameResult.LOSE);
        }
    ...
    class PlayerWinTest {
        ...
        void dealerBustTest() {
            ...
            assertThat(player.compete(dealer)).isEqualTo(GameResult.WIN);
        }
        ...
        void playerHandValueHigherThanDealer() {
            Player player = new Player(score21Hand, "jazz");
            Dealer dealer = new Dealer(score14Hand);
    ...
    class PlayerBlackjackWinTest {
        ...
        void dealerBustTest() {
            ...
            assertThat(player.compete(dealer)).isEqualTo(GameResult.BLACKJACK_WIN);
        }
    }
    ...
    class PlayerDealerDrawTest {
        ...
        void allBlackjackTest() {
            ...
            assertThat(player.compete(dealer)).isEqualTo(GameResult.DRAW);
        }

        @Test
        @DisplayName("플레이어와 딜러 모두 점수가 동일하면 무승부.")
        void tieScoreTest() {
            Player player = new Player(score21Hand, "jazz");
            Dealer dealer = new Dealer(score21Hand);
