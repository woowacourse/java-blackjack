...
public class OutputView {
    ...
    public static final String DRAW_AT_FIRST_GUIDE_MESSAGE = "달러와 %s 에게 2장의 카드를 나누었습니다.";
    public static final String DEALER_HIT_MESSAGE = "딜러는 16이하라 한장의 카드를 더 받았습니다.";
    ...
    public static void printShowUsersCardMessage(List<Player> players) {
        ...
        System.out.println(String.format((DRAW_AT_FIRST_GUIDE_MESSAGE), String.join(",", playerNames)));
    }
