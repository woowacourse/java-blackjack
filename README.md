...
- [x] 도메인
    ...
    - Score
        - [x] 21이면 블랙잭이다.
        - [x] 21을 초과하면 버스트다.
        - [x] 플레이어는 21을 넘지 않을 경우 히트할 수 있다.
        - [x] 딜러는 16을 넘지 않을 경우 히트할 수 있다.
    - Result
    - Judge
        - [x] 플레이어가 21을 초과하면 플레이어는 패배하고 딜러는 승리한다.
        - [x] 플레이어가 21을 초과하지 않고 딜러가 21을 초과하면 플레이어는 승리하고 딜러는 패배한다.
        - [x] 플레이어와 딜러가 21을 초과하지 않으면 플레이어가 딜러보다 합이 높을 때 플레이어가 승리하고 딜러가 패배한다.
- [x] 출력
