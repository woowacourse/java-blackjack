...
- [ ] 게임을 완료한 후 각 플레이어별로 최종 수익을 출력한다
...
- [ ] 카드를 추가로 뽑아 21을 초과할 경우 플레이어는 배팅 금액을 모두 잃는다
- [ ] 처음 두 장의 카드 합이 21으로 블랙잭이 되면 베팅 금액의 1.5배를 딜러에게 받는다
- [ ] 딜러와 플레이어가 모두 동시에 블랙잭인 경우 플레이어는 베팅한 금액을 돌려받는다
- [ ] 딜러와 플레이어의 점수가 21점을 넘지 않으면서 같은 경우 플레이어는 베팅한 금액을 돌려받는다
- [ ] 딜러가 21점을 초과하면 그 시점까지 남아있던 플레이어는 가지고 있는 패에 상관없이 승리해 베팅 금액을 받는다
- [ ] 딜러와 플레이어의 점수가 21점을 넘지 않으면서 플레이어 점수가 높은 경우 플레이어는 승리해 베팅 금액을 받는다
