...
class MoneyTest {
    ...
    @DisplayName("블랙잭 게임을 블랙잭으로 승리할 경우 1.5배 수익을 리턴한다.")
    @Test
    ...
    @DisplayName("블랙잭 게임을 승리할 경우 1배 수익을 리턴한다.")
    @Test
    void testWinProfit() {
        Money money = new Money(1000);
    ...
    @DisplayName("블랙잭 게임을 패배할 경우 -1배 수익을 리턴한다.")
    @Test
    void testLoseProfit() {
        Money money = new Money(1000);
    ...
    @DisplayName("블랙잭 게임을 비길 경우 0원 수익을 리턴한다.")
    @Test
    void testDrawProfit() {
        Money money = new Money(1000);
        assertThat(money.profit(GameResult.DRAW, false).getValue()).isEqualTo(0);
    }
