...
public class OutputView {
  ...
  private static final String DRAW_RESULT_FORMAT = System.lineSeparator() + "딜러와 %s에게 2장의 카드를 나누었습니다.";
  private static final String DECK_STATE_FORMAT = "%s 카드: %s" + System.lineSeparator();
  private static final String DEALER_DRAWABLE_MESSAGE = System.lineSeparator() + "딜러는 16이하라 한장의 카드를 더 받았습니다.";
  ...
  public static void printDealerAndPlayersDeckState(PlayerDto dealer, List<PlayerDto> gamersDeck) {
    System.out.printf(DECK_STATE_FORMAT, dealer.getName(), dealer.getCardList().get(0).getName());
