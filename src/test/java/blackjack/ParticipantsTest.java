...
public class ParticipantsTest {
	...
	void Player_Number_Exceed_Exception() {
		assertThatThrownBy(() -> {
			...
			Participants.createFrom(players);
	...
	void Illegal_Choice_Format_Exception() {
		...
		Participants participants = Participants.createFrom(Arrays.asList("yaho", "panda"));
		assertThatThrownBy(() ->
			participants.receiveAdditionalCard(players.get(0), "123!")
		).isInstanceOf(IllegalArgumentException.class)
