...
class PlayerTest {
    ...
    void total_score_under_21() {
        ...
        player.hand.updateCardScore(new Card(CardNumber.ACE, CardSymbol.HEART));
        player.hand.updateCardScore(new Card(CardNumber.FIVE, CardSymbol.HEART));
    ...
    void total_score_over_21() {
        // given & when
        Player player = new Player(new Name("Merry"));
        player.hand.updateCardScore(new Card(CardNumber.KING, CardSymbol.HEART));
        player.hand.updateCardScore(new Card(CardNumber.FIVE, CardSymbol.HEART));
        player.hand.updateCardScore(new Card(CardNumber.KING, CardSymbol.HEART));
