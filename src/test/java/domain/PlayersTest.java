...
class PlayersTest {
    ...
    void 플레이어의_승패_결과를_도출한다() {
        ...
        // when
        Map<Player, WinningResult> playerWinDrawLoseMap = players.deriveResults(18);

        // then
        assertThat(playerWinDrawLoseMap.get(player1)).isEqualTo(WinningResult.WIN);
        assertThat(playerWinDrawLoseMap.get(player2)).isEqualTo(WinningResult.LOSE);
        assertThat(playerWinDrawLoseMap.get(player3)).isEqualTo(WinningResult.DRAW);
    }
