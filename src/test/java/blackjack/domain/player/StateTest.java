...
public class StateTest {
    ...
    @CsvSource({"BLACKJACK, true", "HIT, false"})
    ...
    @CsvSource({"BLACKJACK, false", "STAY, false", "HIT, true", "BUST, false"})
    ...
    static Stream<Arguments> calculateStateSource() {
        return Stream.of(
                ...
                Arguments.of(List.of(ACE_DIAMOND, FOUR_SPADE, SIX_SPADE), STAY),
                Arguments.of(List.of(KING_SPADE, QUEEN_SPADE), HIT)
        );
    }
}
