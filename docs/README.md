...
- [ ] 수익률 계산
  - [ ] 블랙잭
    - [ ] 참가자와 딜러가 모두 블랙잭이면, 참가자는 베팅한 금액을 돌려받는다.
    - [ ] 참가자만 블랙잭이면 참가자는 *1.5, 딜러는 그 값의 마이너스가 된다.
    - [ ] 딜러만 블랙잭이면 참가자는 배팅금액 그대로 마이너스, 딜러는 그 값을 받게 된다.
  - [ ] 버스트
    - [ ] '참가자만 버스트'이거나 '참가자와 딜러가 모두 버스트'면, 참가자는 배팅금액 그대로 마이너스, 딜러는 그 값을 받게 된다.
    - [ ] 딜러만 버스트면 참가자는 배팅금액을 받게 되고, 딜러는 그 값의 마이너스가 된다.
  - [ ] Stay
    - [ ] 승을 한 쪽이 참가자 배팅금액의 플러스, 패를 한 쪽이 참가자 배팅금액의 마이너스를 받게 된다.
