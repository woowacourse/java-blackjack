...
public class OutputWriter {
    ...
    private static final String INPUT_NAME_GUIDE_MESSAGE = "게임에 참여할 사람의 이름을 입력하세요.(쉼표 기준으로 분리)";
    private static final String DEAL_INITIAL_CARD_MESSAGE = "딜러와 %s에게 2장을 나누었습니다.";
    ...
    private static final String BETTING_GUIDE_MESSAGE = "%s의 배팅 금액은?";
    private static final String FINAL_PROFIT_TITLE_MESSAGE = "## 최종 수익";
    private static final String GAMER_PROFIT_FORMAT = "%s: %d";
    ...
    public void printGamerProfit(String playerName, int profit) {
