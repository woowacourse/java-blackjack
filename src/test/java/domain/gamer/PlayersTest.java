...
public class PlayersTest {
    ...
    void createDomainByInvalidMaxSize() {
        assertThatThrownBy(() -> new Players(List.of(
                new Player("player1", new Hand()),
                new Player("player2", new Hand()),
                new Player("player3", new Hand()),
                new Player("player4", new Hand()),
                new Player("player5", new Hand()),
                new Player("player6", new Hand()),
                new Player("player7", new Hand()),
                new Player("player8", new Hand()),
                new Player("player9", new Hand()))))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("[ERROR] 플레이어는 최소 1명에서 최대 8명까지 참여할 수 있습니다.");
    }
    ...
    void createDomainByInvalidName() {
        assertThatThrownBy(() -> new Players(List.of(new Player("딜러", new Hand()))))
                .isInstanceOf(IllegalArgumentException.class)
