...
class BetLeverageTest {
    ...
    void of(Hands dealerHands, Hands playerHands, BetLeverage expected) {
        BetLeverage betLeverage = BetLeverage.of(StandState.from(dealerHands), StandState.from(playerHands));
    ...
    static Stream<Arguments> handsAndWinStatus() {
        return Stream.of(                                                  // 딜러(카드수) | 참여자(카드수) | 레버리지
                arguments(score20count2, score21count2, BetLeverage.LUCKY),  // 생존(2)    , 블랙잭(2)     , 1.5
                arguments(score22count3, score21count2, BetLeverage.LUCKY),  // 죽음(3)    , 블랙잭(2)     , 1.5
                arguments(score21count3, score21count2, BetLeverage.LUCKY),  // 블랙잭(3)   , 블랙잭(2)    , 1.5
                ...
                arguments(score21count2, score21count2, BetLeverage.DRAW),   // 블랙잭(2)   , 블랙잭(2)     , 0
                arguments(score21count3, score21count3, BetLeverage.DRAW),   // 블랙잭(3)   , 블랙잭(3)     , 0
                arguments(score20count2, score20count2, BetLeverage.DRAW)    // 생존(2)    , 생존(2)       , 0
        );
    }
