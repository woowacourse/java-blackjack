...
public class Message {
    ...
    public final static String INPUT_BETTING_MONEY_MESSAGE = "\n%s의 배팅 금액은?";
    public final static String DEAL_CARDS_MESSAGE = "\n딜러와 %s에게 2장을 나누었습니다.";
    public final static String DEALER_CARDS_MESSAGE = "딜러 카드: %s";
    public final static String REQUEST_GET_EXTRA_CARD = "%s는 한장의 카드를 더 받겠습니까?(예는 y, 아니오는 n)";
    public final static String DEALER_CARD_RECEIVE_ANNOUNCE = "\n딜러는 16이하라 한장의 카드를 더 받았습니다.";
