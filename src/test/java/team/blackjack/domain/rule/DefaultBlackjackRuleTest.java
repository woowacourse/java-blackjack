...
class DefaultBlackjackRuleTest {
     ...
     */
    @Test
    void 플레이어가_블랙잭이면서_딜러는_블랙잭이_아닐때_플레이어는_BLACKJACK() {
        Hand playerHand = new Hand();
        Hand dealerHand = new Hand();
    ...
    @Test
    void 플레이어가_블랙잭이_아니면서_딜러는_블랙잭일때_플레이어는_LOSE() {
        Hand playerHand = new Hand();
        Hand dealerHand = new Hand();
    ...
    @Test
    void 플레이어와_딜러_둘다_블랙잭일때_플레이어는_DRAW() {
        Hand playerHand = new Hand();
        Hand dealerHand = new Hand();
     ...
     */
    @Test
    void 딜러의_승패를_계산할때_딜러가_플레이어보다_더_높으면_LOSE() {
        Hand playerHand = new Hand();
        Hand dealerHand = new Hand();
