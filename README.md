...
- [x] 딜러의 정보를 반환한다.
- [x] 플레이어의 정보를 반환한다.
- [x] 받은 플레이어의 돈을 잃게 만들고, 딜러의 돈으로 추가한다.
- [x] 받은 플레이어의 돈에 보너스를 추가하고, 그만큼 딜러에게서 제거한다.
- [x] 받은 플레이어의 돈을 그대로 유지한다.
- [x] 전체 참가자의 정보를 반환한다.
...
- [x] 플레이어가 버스트라면, 해당 플레이어의 베팅 금액을 모두 딜러에게 넘긴다.
- [x] 딜러가 버스트라면 플레이어에게 초기 베팅 금액을 돌려주고, 아니라면 게임 결과를 판단하여 최종 수익을 계산한다.
...
- [x] 처음에 2장을 받은 후, 딜러가 승리한지 판단한다.
- [x] 처음에 2장을 받은 후, 플레이어가 승리한지 판단한다.
- [x] 최종적으로 딜러가 승리한지 판단한다.
- [x] 최종적으로 플레이어가 승리한지 판단한다.
- [x] 플레이어와 딜러가 모두 블랙잭인지 판단한다.
