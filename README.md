...
- [ ] 딜러의 점수와 같으면 베팅한 금액만 돌려받는다.
- [ ] 딜러의 점수보다 낮다면 베팅 금액을 돌려받지 못한다.
- [ ] 딜러의 점수보다 높다면 베팅 금액을 추가로 받는다.
- [ ] 딜러가 21을 초과한다면 남아있는 플레이어들은 베팅 금액을 추가로 받는다.
    - [ ] 딜러가 21을 초과하기 전에 21을 초과한 플레이어에 한해서는 베팅 금액을 돌려받지 못한다.
- [ ] 블랙잭일 경우, 베팅 금액의 1.5배를 추가로 받는다.
    - [ ] 단, 딜러가 블랙잭일 경우, 무승부로 간주해 베팅한 금액만 돌려받는다.
