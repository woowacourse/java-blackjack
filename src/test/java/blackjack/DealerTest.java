...
public class DealerTest {
    ...
    @Test
    void isHitTest() {
        assertThat(Dealer.generate().isStateSame(State.HIT)).isTrue();
    }
    ...
    void isHitTest2() {
        ...
        assertThat(dealer.isStateSame(State.HIT)).isFalse();
    }
    ...
    void isBlackjackTest() {
        ...
        dealer.drawInitialCards(deck);
        assertThat(dealer.isStateSame(State.BLACKJACK)).isTrue();
    }
    ...
    void isBlackjackTest2() {
        ...
        assertThat(dealer.isStateSame(State.BLACKJACK)).isFalse();
    }
    ...
    void isBurstTest_true() {
        ...
        dealer.drawInitialCards(deck);
        dealer.drawAdditionalCard(deck);
        assertThat(dealer.isStateSame(State.BUST)).isTrue();
    }
    ...
    void isBurstTest_false() {
        ...
        dealer.drawInitialCards(deck);
        dealer.drawAdditionalCard(deck);
        assertThat(dealer.isStateSame(State.BUST)).isFalse();
    }
