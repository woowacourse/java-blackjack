...
class PlayerTest {
    ...
    @DisplayName("플레이어가 블랙잭으로 승리하면 베팅 금액의 1.5배를 받는다")
    @Test
    void winBlackJackWithBetMoney() {
        List<Card> given = List.of(
                new Card(CardNumber.ACE, CardShape.HEART),
                new Card(CardNumber.TEN, CardShape.SPADE)
        );
        ...
        assertThat(playerResult).isEqualTo(4500);
    }

    @DisplayName("플레이어와 딜러가 동시에 블랙잭인경우 베팅한 금액을 돌려받는다")
    @Test
    void doubleBlackJackWithBetMoney() {
        List<Card> given = List.of(
                new Card(CardNumber.ACE, CardShape.HEART),
                new Card(CardNumber.TEN, CardShape.SPADE)
        );
    ...
    @DisplayName("딜러와 플레이어의 점수가 21점을 넘지 않으면서 같은 경우 베팅한 금액을 돌려받는다")
    @Test
    void sameScoreWithBetMoney() {
        List<Card> given = List.of(
                new Card(CardNumber.TWO, CardShape.HEART),
    ...
    @DisplayName("딜러가 21점을 초과하면 플레이어는 베팅한 금액을 받는다")
    @Test
    void dealerBustWithBetMoney() {
        List<Card> given = List.of(
                new Card(CardNumber.TWO, CardShape.HEART),
                new Card(CardNumber.TWO, CardShape.SPADE),
                new Card(CardNumber.TEN, CardShape.SPADE)
    ...
    @DisplayName("딜러와 플레이어의 점수가 21점을 넘지 않으면서 플레이어 점수가 높은 경우 플레이어는 베팅한 금액을 받는다")
    @Test
    void winWithBetMoney() {
        List<Card> given = List.of(
                new Card(CardNumber.TWO, CardShape.HEART),
                new Card(CardNumber.TWO, CardShape.SPADE),
                new Card(CardNumber.TEN, CardShape.SPADE)
