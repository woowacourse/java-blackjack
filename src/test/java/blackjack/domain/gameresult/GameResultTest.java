...
class GameResultTest {
    ...
    void winTest() {
        ...
        Dealer dealer = createDealerWithCars(
                ...
                new Card(Figure.CLOVER, blackjack.domain.card.Number.KING));
        Player player = createPlayerWithCars(
                new Card(Figure.CLOVER, blackjack.domain.card.Number.KING),
                new Card(Figure.CLOVER, blackjack.domain.card.Number.NINE),
                new Card(Figure.CLOVER, blackjack.domain.card.Number.TWO));
    ...
    void loseWhenOnlyDealerIsBlackjackTest() {
        ...
        Dealer dealer = createDealerWithCars(
                new Card(Figure.CLOVER, blackjack.domain.card.Number.KING),
                new Card(Figure.CLOVER, blackjack.domain.card.Number.ACE));
        Player player = createPlayerWithCars(
                new Card(Figure.CLOVER, blackjack.domain.card.Number.NINE),
                new Card(Figure.CLOVER, blackjack.domain.card.Number.KING),
                new Card(Figure.CLOVER, blackjack.domain.card.Number.TWO));
