...
class BlackJackGameTest {
    ...
    @Nested
    @DisplayName("게임 결과 계산 테스트")
    class BlackjackGameResultTest {

        @Test
        @DisplayName("딜러와 플레이어간의 승패를 계산하여 참가자들의 승패 결과를 반환한다")
        void should_return_result_of_dealer_between_player() {
            ...
            // when
            ParticipantsResult participantsResult = blackJackGame.calculateGameResult();
        ...
        @Test
        @DisplayName("딜러가 승리하는 경우에서 참가자들의 승패 결과를 반환한다")
        ...
        @Test
        @DisplayName("딜러가 비기는 경우에서 참가자들의 승패 결과를 반환한다")
        ...
        @Test
        @DisplayName("딜러가 패배하는 경우에서 참가자들의 승패 결과를 반환한다")
