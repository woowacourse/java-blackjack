...
class CardGroupTest {
    ...
    void getSum(Card card, int result, String testName) {
        ...
        cardGroup.addCard(Card.of(CardShape.HEART, CardNumber.Q));
    ...
    private static Stream<Arguments> invalidParameters() {
        return Stream.of(
                ...
                Arguments.of(Card.of(CardShape.HEART, CardNumber.K), 22, "카드 숫자 합 12에서 10 추가시에 22")
        );
    }
    ...
    void isBlackJack() {
        CardGroup cardGroup = new CardGroup();
        cardGroup.addCard(Card.of(CardShape.HEART, CardNumber.A));
        cardGroup.addCard(Card.of(CardShape.HEART, CardNumber.Q));
    ...
    void isNotBlackJack() {
        CardGroup cardGroup = new CardGroup();
        cardGroup.addCard(Card.of(CardShape.HEART, CardNumber.K));
        cardGroup.addCard(Card.of(CardShape.HEART, CardNumber.NINE));
        cardGroup.addCard(Card.of(CardShape.HEART, CardNumber.TWO));
