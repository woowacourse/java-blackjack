...
### Dealer
- [x] 처음에 받은 2장의 합계가 16이하이면 
  - [x] 반드시 1장의 카드를 추가로 받아야 한다. (Hit)
- [x] 17점 이상이면
  - [x] 추가로 받을 수 없다. (Stay)
- [x] 21점 초과할 시, (Bust)
  - [x] 그 시점까지 살아남아있는 참가자들은 가지고 있는 패에 상관 없이 승리해 배팅 금액을 받는다.
