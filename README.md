...
- [x] 딜러와 플레이어들을 가진다.
- [x] 딜러와 플레이어에게 처음 2장의 패를 나눠준다.
- [x] 플레이어를 히트한다.
- [x] 딜러를 히트한다.
- [x] 전체 플레이어의 수익률을 계산한다.
- [x] 딜러의 수익률을 계산한다.
...
- [x] 플레이어의 배팅 금액을 저장한다.
  - [x] 플레이어가 존재하지 않으면 예외를 발생시킨다.
- [x] 플레이어가 블랙잭으로 이기면 배팅금액의 1.5배를 가져간다.
- [x] 플레이어가 블랙잭이 아니고, 이기면 배팅 금액을 가져간다.
- [x] 플레이어가 지면, 배팅 금액을 잃고 그 금액은 딜러가 가진다.
