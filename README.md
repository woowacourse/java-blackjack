...
- 버스트(Bust) 
- 블랙잭(Blackjack)
- [ ] 카드의 합과 카드의 수를 통해 블랙잭 상태를 알 수 있다.
  - [ ] 스탠드: 카드의 합이 21을 넘지 않은 경우 (버스트와 블랙잭이 아닌 경우)
  - [ ] 버스트: 카드의 총합이 21을 넘는 경우
  - [ ] 블랙잭: 2장의 합이 21인 경우 (A 한장과 10에 해당하는 패(10,J,Q,K)로 21을 이루는 경우)

### 게임 머니
- [x] 배팅 금액을 가지고 있다.
  - [x] 배팅 금액은 0보다 커야한다.
- [ ] 카드 상태와 승패에 따라 최종 수익을 알 수 있다.
