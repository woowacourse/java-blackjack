...
public class PlayerTest {
    ...
    void getTwoCards() {
        Player player = new Player("jason", HoldCards.initTwoCards(Card.valueOf(Suit.SPADE, CardNumber.KING), Card.valueOf(Suit.SPADE, CardNumber.ACE)));
    ...
    void putCard() {
        Player player = new Player("jason", HoldCards.initTwoCards(Card.valueOf(Suit.SPADE, CardNumber.NINE), Card.valueOf(Suit.SPADE, CardNumber.ACE)));
