...
public class Fixtures {
    ...
    public static final Card SPADE_JACK = new Card(Suit.SPADE, Rank.JACK);
    public static final Card SPADE_TEN = new Card(Suit.SPADE, Rank.TEN);
    public static final Card SPADE_EIGHT = new Card(Suit.SPADE, Rank.EIGHT);
