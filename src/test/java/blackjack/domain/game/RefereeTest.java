...
public class RefereeTest {
    ...
    private CardPicker playerCardPicker, dealerCardPicker;
    ...
    @BeforeEach
    void setupGamer() {
        dealer = new Dealer(new Hand(List.of()));
        referee = new Referee();
    ...
    void assertResult() {
        // when
        players.forEach(player -> player.draw(playerCardPicker.pickCard()));
        dealer.draw(dealerCardPicker.pickCard());
    ...
    void playerWinTest() {
        // given
        playerCardPicker = new CardPicker(new Deck(Arrays.asList(Card.values()))) {
            @Override
            public List<Card> pickCards(int count) {
                return List.of(Card.SPADE_NINE, Card.CLUB_QUEEN);
            }
        };
        dealerCardPicker = new CardPicker(new Deck(Arrays.asList(Card.values()))) {
            @Override
            public List<Card> pickCards(int count) {
    ...
    void playerDrawWhenSameBlackjackTest() {
        ...
        expectedPlayersResult.put(name, GameResult.PUSH);
    }
