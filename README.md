...
- [ ] 손패를 생성할 때 금액을 갖도록 구성한다.
  - [ ] 자신의 금액을 반환할 수 있다. 

- [ ] Gamer들은 각자 금액을 갖는다.
  - [ ] Gamer의 손패에 금액을 갖도록 구성한다.
  - [ ] 손패를 통해 금액을 반환할 수 있다.

- [ ] 손패의 결과에 따라 금액을 반환한다.
  - [ ] 게임의 결과가 패배이면 잃는다.
    - [ ] 상대방이 블랙젝이면 1.5배 잃는다.
    - [ ] 상대방이 블랙젝이 아니면 1배를 잃는다.
  - [ ] 게임의 결과가 승리이면 얻는다.
    - [ ] 자신이 블랙젝이면 1.5배 얻는다.
    - [ ] 자신이 블랙젝이 아니면 1배를 얻는다.
  - [ ] 게임의 결과가 무승부이면 1배를 잃는다.
    - [ ] 자신과 상대방이 블랙젝이면 자신이 1배를 잃는다.
    - [ ] 자신과 상대방이 같은 점수이면 자신이 1배를 잃는다.
