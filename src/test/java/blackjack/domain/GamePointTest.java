...
public class GamePointTest {
    ...
    void gamePointCalculateTest() {
        ...
        assertThat(gamePoint.optimizeValue()).isEqualTo(9);
    }
    ...
    void optimizeCalculateTest1() {
        ...
        final GamePoint gamePoint = new GamePoint(data);
        assertThat(gamePoint.optimizeValue()).isEqualTo(16);
    }
    ...
    void optimizeCalculateTest2() {
        ...
        final GamePoint gamePoint = new GamePoint(data);
        assertThat(gamePoint.optimizeValue()).isEqualTo(0);
    }
    ...
    void optimizeCalculateTest3() {
        ...
        final GamePoint gamePoint = new GamePoint(data);
        assertThat(gamePoint.optimizeValue()).isEqualTo(21);
    }
