...
class HandCardsTest {
    static Stream<Arguments> provideHandCardsData() {
        return Stream.of(
                ...
                Arguments.of(List.of(new Card(TrumpSuit.HEART, TrumpNumber.SEVEN), new Card(TrumpSuit.CLUB, TrumpNumber.FOUR),
                        new Card(TrumpSuit.CLUB, TrumpNumber.ACE)), 12), // ACE가 1로 처리되어야 하는 경우 (1)
                Arguments.of(List.of(new Card(TrumpSuit.HEART, TrumpNumber.TEN), new Card(TrumpSuit.CLUB, TrumpNumber.TEN),
                        new Card(TrumpSuit.CLUB, TrumpNumber.ACE)), 21), // ACE가 1로 처리되어야 하는 경우 (2)
