...
public class InputView {
    ...
    private static final String REQUEST_MORE_CARD_INPUT_FORMAT = "%s는 한장의 카드를 더 받겠습니까? (예는 " + YES + ", 아니오는 " + NO + ")";
    ...
    public static boolean requestMoreCardInput(String playerName) {
