...
- [ ] 플레이어의 베팅 금액을 입력 받는다.
- [ ] [예외] 베팅 금액에 빈 값이 입력된 경우
- [ ] [예외] 베팅 금액이 숫자가 아닌 값이 입력된 경우
...
- [ ] 플레이어의 처음 뽑은 카드 두 장 숫자의 합이 21인지 확인한다.
- [ ] 플레이어의 처음 뽑은 카드 두 장 숫자의 합이 21 초과인지 확인한다.
- [ ] 딜러의 처음 뽑은 카드 두 장 숫자의 합이 21인지 확인한다.
- [ ] 플레이어의 베팅 금액을 계산한다.
