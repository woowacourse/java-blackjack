...
class ProfitCalculatorTest {
    ...
    void 플레이어가_처음_받은_카드_두_장의_합이_21이고_딜러는_아닐_경우_플레이어의_수익은_베팅한_금액의_1_5배이다() {
        ...
        assertThat(profitCalculator.calculatePlayerProfit(player, dealer)).isEqualByComparingTo(BigDecimal.valueOf(1500));
    }
    ...
    void 플레이어가_승리할_경우_플레이어의_수익은_자신이_베팅한_금액이다() {
        ...
        assertThat(profitCalculator.calculatePlayerProfit(player, dealer)).isEqualByComparingTo(BigDecimal.valueOf(1000));
    }
    ...
    void 무승부일_경우_플레이어의_수익은_0원이다() {
        ...
        assertThat(profitCalculator.calculatePlayerProfit(player, dealer)).isEqualByComparingTo(BigDecimal.valueOf(0));
    }
}
