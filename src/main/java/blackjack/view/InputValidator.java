...
public class InputValidator {
	...
	private final static String NO_INPUT_ERROR = "입력 값이 없습니다.";
	private final static String INPUT_CONTAINS_SPACE_ERROR = "입력 값에 공백을 포함할 수 없습니다.";
	private final static String NAME_DUPLICATED_ERROR = "중복된 이름을 사용할 수 없습니다.";
	private static final String PROPER_CHOICE_ERROR = "선택하는 입력 값은 y 또는 n 이어야 합니다.";
	private final static String SPACE = " ";
	private final static String NAME_DISTRIBUTOR = ",";
	private final static String CHOICE_YES = "y";
	private final static String CHOICE_NO = "n";
