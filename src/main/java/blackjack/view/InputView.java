...
public class InputView {
    ...
    private static final String INVALID_MONEY_AMOUNT = "금액은 숫자로 입력해야 합니다.";
    ...
    public Money askBettingMoneyToPlayer(final String playerName) {
    ...
    private Money convertInputToMoney(final String input) {
        int moneyAmount = parseInputToMoneyAmount(input);
        return parseMoneyAmountToMoney(moneyAmount);
    }

    private int parseInputToMoneyAmount(String input) {
        try {
    ...
    private Money parseMoneyAmountToMoney(int amount) {
