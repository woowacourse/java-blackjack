...
- [ ]  딜러와 각 참가자들에 대한 승패를 판정한다.
    - [ ]  참가자가 버스트면 참가자는 배팅 금액을 모두 잃는다.
    - [ ]  딜러와 참가자 둘 다 블랙잭인 경우 참가자는 배팅 금액을 돌려받는다.
    - [ ]  참가자만 블랙잭인 경우 참가자는 배팅 금액의 1.5배를 받는다.
    - [ ]  딜러가 버스트면 남은 참가자는 모두 배팅 금액을 받는다.
    - [ ]  남은 딜러와 참가자 중 점수가 더 큰 사람이 배팅 금액을 받는다.
    - [ ]  딜러와 참가자의 점수가 동점일 경우 참가자는 배팅 금액을 돌려받는다.
- [ ]  최종 수익을 출력한다.
