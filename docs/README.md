...
### 베팅 금액 조건
#### 플레이어가 추가로 돈을 받는 경우
- [x] 플레이어가 만약 블랙잭으로 승리한 경우, 베팅 금액의 1.5배만큼을 추가로 딜러에게 받는다.
- [ ] 플레이어가 승리한 경우, 플레이어의 베팅 금액만큼을 추가로 받는다.

#### 플레이어가 돈을 받지도, 잃지도 않는 경우 
- [ ] 플레이어가 무승부인 경우, 베팅 금액만 돌려받는다 (= 추가로 돈을 받지 않는다.)
  - [x] 만약 블랙잭으로 무승부인 경우도 포함
- [x] 딜러가 21을 초과하면 그 시점까지 남아 있던 플레이어들은 가지고 있는 패에 상관 없이 승리해 베팅 금액을 돌려받는다.

#### 플레이어가 돈을 잃는 경우
- [ ] 플레이어가 지는 경우, 베팅 금액만큼을 잃는다.

### 배팅 금액
- [x] 배팅 금액의 특정 배수만큼의 곱을 얻을 수 있다.
- [x] 배팅 금액의 전체를 잃을 수 있다.
