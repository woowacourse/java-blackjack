...
public class BlackJackGameTest {
    ...
    public void setUp() {
        ...
        blackJackGame = new BlackJackGame(cards);
    ...
    public void 플레이어가_버스트인_경우_정상_작동() {
        ...
        Integer profit1 = blackJackGame.getGameResult(new Participants(List.of(player)), dealer).dealerWinning().getTotalBet();

        assertThat(profit1).isEqualTo(0);

        participantBust(dealer);

        Integer profit2 = blackJackGame.getGameResult(new Participants(List.of(player)), dealer).dealerWinning().getTotalBet();
    ...
    public void 플레이어만_블랙잭인_경우_정상_작동() {
        ...
        Integer profit = blackJackGame.getGameResult(new Participants(List.of(player)), dealer).dealerWinning().getTotalBet();
