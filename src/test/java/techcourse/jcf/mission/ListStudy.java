...
public class ListStudy {
    ...
    public void simpleArrayList() {
        ...
        assertThat(values.set(0, "new")).isEqualTo("second");
        assertThat(values.indexOf("new")).isEqualTo(0);
        assertDoesNotThrow(() -> values.add(1, "two"));
        assertThat(values.remove("new")).isTrue();

        assertDoesNotThrow(values::clear);
