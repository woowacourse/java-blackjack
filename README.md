...
- [x] 도메인
    ...
    - Result
      - [x] 플레이어가 버스트면 플레이어는 패배다.
      - [x] 플레이어가 버스트가 아니고 딜러가 버스트면 플레이어는 승리다.
      - [x] 플레이어가 블랙잭이고 딜러는 블랙잭이 아니면 플레이어는 승리다.
      - [x] 플레이어와 딜러가 모두 블랙잭이면 플레이어는 무승부다.
      - [x] 플레이어와 딜러가 모두 버스트가 아니고 플레이어 핸드가 크면 플레이어는 승리다.
      - [x] 플레이어와 딜러가 모두 버스트가 아니고 플레이어 핸드가 작으면 플레이어는 패배다.
      - [x] 플레이어와 딜러가 모두 버스트가 아니고 둘의 핸드가 같으면 플레이어는 무승부다.
    - PlayersResult
      - [x] 딜러의 승리 횟수는 플레이어들의 패배 횟수의 합이다.
      - [x] 딜러의 패배 횟수는 플레이어들의 승리 횟수의 합이다.
      - [x] 딜러의 무승부 횟수는 플레이어들의 무승부 횟수의 합이다.
- [x] 출력
