...
public class ProfitRuleTest {
    ...
    void getBlackJackProfitTest() {
        ...
        ProfitStrategy profitStrategy = ProfitRule.getProfitRule(player, dealer);

        Assertions.assertThat(profitStrategy.calculateProfitStrategy(player, dealer)).isEqualTo(0);
    }
    ...
    void onlyPlayerBlackJackProfitTest() {
        ...
        Assertions.assertThat(profitStrategy.calculateProfitStrategy(player, dealer)).isEqualTo(15_000);
    }
    ...
    void playerWinProfitTest() {
        ...
        Assertions.assertThat(profitStrategy.calculateProfitStrategy(player, dealer)).isEqualTo(10_000);
    }
