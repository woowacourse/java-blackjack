...
- [ ] 플레이어가 처음 받은 두 장의 카드의 합이 21인 경우
    - [ ] 딜러가 처음 받은 두 장의 카드의 합이 21인 경우 플레이어의 수익은 0이다.
    - [ ] 딜러가 처음 받은 두 장의 카드의 합이 21 이하인 경우 플레이어의 수익은 배팅 금액의 1.5배이다.
- [ ] 플레이어가 처음 받은 두 장의 카드의 합이 21이 아닌 경우
    - [ ] 플레이어가 승리한 경우 배팅 금액만큼의 수익을 얻는다.
    - [ ] 플레이어가 패배한 경우 딜러가 배팅 금액만큼의 수익을 얻는다.
