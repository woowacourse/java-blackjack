...
public class OutputView {
    public static void printCardsStatus(Dealer dealer, Players players) {
        List<String> nameValues = players.getPlayers().stream()
        ...
        players.getPlayers().forEach(OutputView::printCardsStatusOfUser);
    }

    private static void printCardsStatusOfUser(AbstractUser user) {
