...
public class ResultView {
    public void printGameStart(DealerPlayersDTO gameContext) {
    ...
    public void printResult(DealerPlayersDTO gameContext) {
        Players players = gameContext.players();
        Dealer dealer = gameContext.dealer();
    ...
    public void printWinner(DealerPlayersDTO gameContext) {
        Players players = gameContext.players();
        Dealer dealer = gameContext.dealer();
        System.out.println();
