...
class BetAmountRequestDtoTest {
    ...
    void betAmount_is_not_null() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new BetAmountRequestDto(null));
    ...
    void betAmount_is_not_blank() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new BetAmountRequestDto(""));
    }
}