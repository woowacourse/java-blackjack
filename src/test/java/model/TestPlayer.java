...
public class TestPlayer {
    ...
    public void 딜러_이름_예외() {
        assertThatThrownBy(() -> new Player(new PlayerName("딜러"), new BettingMoney("10000")))
    ...
    public void 동일한_플레이어_검증_정상_작동() {
        ...
        Player player1 = new Player(name, bettingMoney);
        Player player2 = new Player(name, bettingMoney);
        Player player3 = new Player(new PlayerName("player2"), bettingMoney);
