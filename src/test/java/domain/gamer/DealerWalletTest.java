...
class DealerWalletTest {
    ...
    void dealerWinProfitTest() {
        PlayingCards playingCards = new PlayingCards(Collections.singletonList(new Card(Symbol.FOUR, Type.HEART)));
        PlayingCards dealerPlayingCards = new PlayingCards(Collections.singletonList(new Card(Symbol.FIVE, Type.DIAMOND)));
        Players players = new Players(Collections.singletonList(new Player("test", 1000, playingCards)));
    ...
    void dealerLoseProfitTest() {
        PlayingCards playingCards = new PlayingCards(Collections.singletonList(new Card(Symbol.SIX, Type.HEART)));
        PlayingCards dealerPlayingCards = new PlayingCards(Collections.singletonList(new Card(Symbol.FIVE, Type.DIAMOND)));
        Players players = new Players(Collections.singletonList(new Player("test", 1000, playingCards)));
        Dealer dealer = new Dealer(dealerPlayingCards);
        PlayersResult playersResult = new PlayersResult(players, dealer);
    ...
    void dealerDrawProfitTest() {
        PlayingCards playingCards = new PlayingCards(Collections.singletonList(new Card(Symbol.FIVE, Type.HEART)));
        PlayingCards dealerPlayingCards = new PlayingCards(Collections.singletonList(new Card(Symbol.FIVE, Type.DIAMOND)));
        Players players = new Players(Collections.singletonList(new Player("test", 0, playingCards)));
        Dealer dealer = new Dealer(dealerPlayingCards);
        PlayersResult playersResult = new PlayersResult(players, dealer);
        PlayerWallets playerWallets = new PlayerWallets(playersResult);
        DealerWallet dealerWallet = new DealerWallet(dealer, playerWallets);
    ...
    void dealerBlackJackLoseProfitTest() {
        ...
        PlayingCards dealerPlayingCards = new PlayingCards(Collections.singletonList(new Card(Symbol.NINE, Type.SPADE)));
