...
public class PlayersTest {
    ...
    void isNotOverPossiblePlayerRange() {
        List<Player> players = List.of(Player.joinGame("pola", new ArrayList<>(), 100));
    ...
    void isOverPossiblePlayerRange() {
        List<Player> players = List.of(Player.joinGame("pola", new ArrayList<>(), 100),
                Player.joinGame("ato", new ArrayList<>(), 100),
                Player.joinGame("hogi", new ArrayList<>(), 100),
                Player.joinGame("jazz", new ArrayList<>(), 100),
                Player.joinGame("cola", new ArrayList<>(), 100),
                Player.joinGame("bumble", new ArrayList<>(), 100),
                Player.joinGame("neo", new ArrayList<>(), 100),
                Player.joinGame("sola", new ArrayList<>(), 100),
                Player.joinGame("bri", new ArrayList<>(), 100)
        );
    ...
    void isPlayersHasDuplicateName() {
        List<Player> players = List.of(Player.joinGame("pola", new ArrayList<>(), 100),
                Player.joinGame("ato", new ArrayList<>(), 100),
                Player.joinGame("pola", new ArrayList<>(), 100)
        );
