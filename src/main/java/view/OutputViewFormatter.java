...
public class OutputViewFormatter {
    public static String formatDealerResult(DealerFinalResultDto dealerFinalResultDto) {
    ...
    public static String formatDealerCardStatus(ResultDto resultDto) {
        return String.format("딜러카드: %s%n", resultDto.cards().getFirst());
    }

    public static String formatPlayerCardStatus(PlayerDto playerDto) {
        return String.format("%s카드: %s%n", playerDto.name(), getCardStatusFormat(playerDto.resultDto().cards()));
    }

    public static String getCardStatusFormat(List<String> cards) {
        return String.join(", ", cards);
    }

    public static String formatCardResult(String name, ResultDto resultDto) {
