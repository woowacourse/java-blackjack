...
public class OutputView {
    ...
    public void printHandOutput(String name, HandDto handDto) {
    ...
    public void printScoreResult(ScoreResultDto scoreResultDto) {
        System.out.println();
    ...
    public void printFinalResult(FinalResultDto finalResultDto) {
    ...
    private String getHandString(HandDto handDto) {
