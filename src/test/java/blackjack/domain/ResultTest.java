...
public class ResultTest {
    ...
    void should_getBetResult_When_Win() {
        ...
        assertThat(result.findBetProfit(new BetMoney(1_000))).isEqualTo(1_000);
    }
    ...
    void should_getBetResult_When_DRAW() {
        ...
        assertThat(result.findBetProfit(new BetMoney(1_000))).isEqualTo(0);
    }
    ...
    void should_getBetResult_When_BlackJack() {
        ...
        assertThat(result.findBetProfit(new BetMoney(1_000))).isEqualTo(1_500);
    }
}
