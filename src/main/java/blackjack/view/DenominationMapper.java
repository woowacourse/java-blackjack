...
public enum DenominationMapper {
    ...
    DenominationMapper(Denomination denomination, String value) {
    ...
    public static String map(Denomination denomination) {
        return Arrays.stream(values())
                .filter(denominationMapper -> denominationMapper.denomination.equals(denomination))
                .map(DenominationMapper::getValue)
                .findAny()
