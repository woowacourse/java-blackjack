...
class PlayersTest {
    ...
    void test1() {
        //given
        Player player1 = Player.init("포비", "100000");
        Player player2 = Player.init("포비", "100000");
        //when & then
    ...
    void test2() {
        //given
        Player player1 = Player.init("짱구", "100000");
        Player player2 = Player.init("밍곰", "100000");
        Player player3 = Player.init("포비", "100000");
        Player player4 = Player.init("네오", "100000");
        Player player5 = Player.init("가이온", "100000");
        Player player6 = Player.init("플린트", "100000");
