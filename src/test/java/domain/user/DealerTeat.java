...
public class DealerTeat {
	...
	void isBlackjackTrueTest() {
		...
		dealer.addCards(new Card(CLOVER, ACE), new Card(CLOVER, JACK));
	...
	void isBlackjackFalseTest() {
		Dealer dealer = new Dealer();
		dealer.addCards(new Card(CLOVER, ACE), new Card(CLOVER, FIVE), new Card(HEART, FIVE));
	...
	void isBlackjackFalseTest2() {
		Dealer dealer = new Dealer();
		dealer.addCards(new Card(CLOVER, ACE), new Card(CLOVER, FIVE));
	...
	void isBlackjackFalseTest3() {
		Dealer dealer = new Dealer();
		dealer.addCards(new Card(CLOVER, ACE), new Card(CLOVER, FIVE), new Card(CLOVER, THREE));
	...
	void isDrawableTest() {
		Dealer dealer = new Dealer();
		dealer.addCards(new Card(HEART, EIGHT),
	...
	void getInitialCardTest() {
		...
		assertThat(dealer.getInitialCard()).containsExactly(new Card(HEART, EIGHT));
	}
	...
	void isBustTrueTest() {
		Dealer dealer = new Dealer();
		dealer.addCards(new Card(HEART, EIGHT), new Card(CLOVER, NINE), new Card(SPADE, JACK));
	...
	void isBustFalseTest() {
		Dealer dealer = new Dealer();
		dealer.addCards(new Card(HEART, EIGHT), new Card(SPADE, JACK));
