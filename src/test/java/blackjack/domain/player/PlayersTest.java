...
public class PlayersTest {
    ...
    void create_players() {
        ...
        Player aki = new Participant(new Name("aki"), deck, new BetMoney(1));
        Player alien = new Participant(new Name("alien"), deck, new BetMoney(1));
    ...
    void duplicate_name_error() {
        Deck deck = new RandomDeck();
        Player aki1 = new Participant(new Name("aki"), deck, new BetMoney(1));
        Player aki2 = new Participant(new Name("aki"), deck, new BetMoney(1));
    ...
    void same_dealer_name_error() {
        Deck deck = new RandomDeck();
        Player player = new Participant(new Name("딜러"), deck, new BetMoney(1));
