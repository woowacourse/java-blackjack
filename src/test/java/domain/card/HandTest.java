...
public class HandTest {
    ...
    void totalScore() {
        Hand hand = new Hand();
        hand.add(Card.from(CardType.DIAMOND, CardNumber.TWO));
        hand.add(Card.from(CardType.DIAMOND, CardNumber.FIVE));
    ...
    void notChangeAceScore() {
        Hand hand = new Hand();
        hand.add(Card.from(CardType.DIAMOND, CardNumber.ACE));
        hand.add(Card.from(CardType.DIAMOND, CardNumber.THREE));
        Assertions.assertThat(hand.getResultScore())
                .isEqualTo(14);
    }
    ...
    void changeAceScore() {
        ...
        hand.add(Card.from(CardType.DIAMOND, CardNumber.ACE));
        hand.add(Card.from(CardType.DIAMOND, CardNumber.ACE));
        hand.add(Card.from(CardType.DIAMOND, CardNumber.TEN));
        hand.add(Card.from(CardType.DIAMOND, CardNumber.SIX));
        Assertions.assertThat(hand.getResultScore())
                .isEqualTo(18);
    }
