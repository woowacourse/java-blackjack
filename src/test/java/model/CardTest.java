...
class CardTest {
    ...
    void toString_CardNumberValueAndEmblemValueToString_IsEqualsToFormattedString(Card card) {
        ...
        List<String> expectedCards = List.of(
                ...
                "7다이아몬드", "8다이아몬드", "9다이아몬드", "10다이아몬드", "J다이아몬드", "Q다이아몬드", "K다이아몬드",
                "A클로버", "2클로버", "3클로버", "4클로버", "5클로버", "6클로버", "7클로버", "8클로버",
                "9클로버", "10클로버", "J클로버", "Q클로버", "K클로버",
                "A하트", "2하트", "3하트", "4하트", "5하트", "6하트", "7하트", "8하트", "9하트", "10하트",
                "J하트", "Q하트", "K하트"
        );
