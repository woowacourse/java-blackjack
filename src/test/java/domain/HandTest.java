...
class HandTest {
    ...
    class CalculateAllScore {
        ...
        private static Stream<Arguments> getCardList() {
            return Stream.of(
                Arguments.of(List.of(new TrumpCard(Rank.NINE, Suit.CLUB), new TrumpCard(Rank.NINE, Suit.HEART)),
                    18),
                Arguments.of(List.of(new TrumpCard(Rank.ACE, Suit.CLUB), new TrumpCard(Rank.ACE, Suit.HEART)),
                    12),
                Arguments.of(List.of(new TrumpCard(Rank.ACE, Suit.CLUB), new TrumpCard(Rank.TEN, Suit.HEART)),
                    21),
                Arguments.of(List.of(new TrumpCard(Rank.ACE, Suit.CLUB), new TrumpCard(Rank.ACE, Suit.HEART),
