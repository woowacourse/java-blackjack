...
- [x] 베팅 금액(BettingMoney)
  - [x] 베팅 금액은 10,000,000원 이하만 생성이 가능하다
  - [x] 베팅 금액은 100원 이상만 생성이 가능하다
- [x] 베팅 머니 테이블(BettingMoneyTable)
...
- [x] 블랙잭 게임(Blackjack)
    ...
    - [x] 딜러 카드의 합계가 16이하이면, 17이상이 될 때까지 카드를 한 장씩 제공한다
